...
Pipeline: checkout `[private]` → sample tracks from city parquet files into `gpx/` → `gpx-art.py` applies each registered style → write `images/<style>-<track>.png`.
