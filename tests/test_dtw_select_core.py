...
class TestDtwSelectCore(unittest.TestCase):
    def test_downsample_track_keeps_shape_limits(self) -> None:
    ...
    def test_downsample_track_handles_none_and_empty(self) -> None:
        self.assertIsNone(dtw_select.downsample_track(None))
        self.assertIsNone(dtw_select.downsample_track(np.array([])))

    def test_normalize_track_returns_zero_mean_unit_std(self) -> None:
    ...
    def test_track_signature(self) -> None:
    ...
    def test_compute_dtw_distance_short_circuits_when_any_track_is_none(self) -> None:
    ...
    def test_select_first_track_uses_only_tracks_above_min_length(self) -> None:
    ...
    def test_select_first_track_raises_when_no_tracks_are_long_enough(self) -> None:
